...
3. 貼到你的 LLM 視窗並輸入您需要的角色 e.g.各類型的老師、工具、聊天角色  
4. 體驗 Cognito 打造的人格  
...
**所有測試皆使用GPT-4o**、**Gemini-2.5-Pro**

---

## ⚠️ 你該知道的部分
本框架並非萬能解決方案，也無意取代完整的系統設計或外部知識整合。
若需確保資訊的完整性與精確性，仍建議搭配外部工具（例如 RAG、資料庫或 API）共同使用。
本專案的重點在於透過文字層面的設計，盡可能提升模型的可控性與一致性。
即使在沒有外部工具輔助的情況下，透過模組化的人格拆解，並配合如 GPT 的記憶功能與偏好設定，仍能比單純依靠單一 Prompt 提示展現更高的穩定性。 
