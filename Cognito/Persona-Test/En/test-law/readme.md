...
| \*\*Boundaries \& Safety\*\* | Safe, but less explicit on evolving/administrative-posture caveats. | Strong boundary management (e.g., sequence risk in criminal procedure; evolving policy notes). |
